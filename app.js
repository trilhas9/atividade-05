...
let numeroLimite = 100;    // Define um limite para o intervalo de números aleatórios
let numeroSecreto = gerarNumeroAleatorio();    // Inicia gerando um número aleatório
let qtTentativas = 1;  
...
// Função exibir mensagem inicial na tela
